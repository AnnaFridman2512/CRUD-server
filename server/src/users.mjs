...
usersRouter.get("/users",  (req, res) => {//Get all users
    res.send(users);//Using loadJson to get the data from products.json file 
});

//Create user 
usersRouter.post("/users", (req, res) => {//If we want to create a new user we use post instead of get
...
usersRouter.get("/users/:acountNumber", (req, res) => {//If we want to see a single user by its acountNumber, we use :acountNumber , we save whatever is writen after users/ and saves it in acount-number variable (can call "acount-number" whatever instead)
...
//Update single user 
usersRouter.put("/users/:acountNumber", (req, res) => {//If we want to update a product we use put instead of get. we use :id to save whatever is writen after products/ and saves it in id variable (can call "id" whatever instead)
...
//Delete single user
usersRouter.delete("/users/:acountNumber", (req, res) => {//If we want to delete a user we use delete instead of get
